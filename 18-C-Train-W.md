...
int main()
{
    int flowers[8] = {1,2,4,5,7,9,12,435};
}
```

+ 如上所示，用以逗号分割的数值列表 (用花括号括起来) 来初始化数组，
...
![train2.png](https://upload-images.jianshu.io/upload_images/9140378-2fe7b3a5aabd1f87.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/300)

+ 如上图所示，数组的首位置的下标一定是0,下标的最大值一定是数组的长度 - 1
